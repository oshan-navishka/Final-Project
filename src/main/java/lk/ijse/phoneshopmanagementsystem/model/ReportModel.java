...
public class ReportModel {
    ...
    public Map<String, Object> getYearlySummary(int year) throws SQLException {
        Map<String, Object> summary = new HashMap<>();
    ...
    public List<Map<String, Object>> getMonthlyOrders(int year, int month) throws SQLException {
    ...
    public List<Map<String, Object>> getYearlyOrders(int year) throws SQLException {
        List<Map<String, Object>> orders = new ArrayList<>();
    ...
    public List<Map<String, Object>> getTopCustomers(int year, int limit) throws SQLException {
    ...
    public Map<String, Integer> getOrderStatusBreakdown(int year) throws SQLException {
    ...
    public List<Integer> getAvailableYears() throws SQLException {
        ...
        String sql = "SELECT DISTINCT YEAR(Order_date) as year " +
                "FROM Orders " +
                "ORDER BY year DESC";
