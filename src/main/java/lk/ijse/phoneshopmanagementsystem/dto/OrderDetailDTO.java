...
public class OrderDetailDTO {
    ...
    public OrderDetailDTO(String orderId, String itemId, int quantity,
    ...
    public OrderDetailDTO(String orderDetailId, String orderId, String itemId, int quantity, double unitPrice,
                          double subtotal, String itemDescription, String itemBrand, String itemModel) {
